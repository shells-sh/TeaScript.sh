...
@pending.reflection.methods.define.hello_world() {
  ...
  assert reflection types methods define Dog add[T,K] i P Dog.add "The dog says 'woof!'"
  assert reflection types methods define Dog anotherMethod S P Dog.anotherMethod
